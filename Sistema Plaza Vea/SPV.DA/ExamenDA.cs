...
namespace SPV.DA
{
    public class ExamenDA
    {
        ...
        {
            querySQL = "SELECT NEXAMENCOD, CEXAMENNOM, CEXAMENDESC, CEXAMENEST, NEXAMENTIPO FROM GRH_EXAMEN WHERE CEXAMENEST = 'ACT'";
        ...
        public ExamenBE BuscarExamen(String p_CodigoExamen) {
            querySQL = "SELECT NEXAMENCOD, CEXAMENNOM, CEXAMENDESC, CEXAMENEST, NEXAMENTIPO FROM GRH_EXAMEN "+
        ...
        public String AgregarExamen(ExamenBE p_Examen)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "sp_AgregarExamen";
